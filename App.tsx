  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-900 text-white flex flex-col overflow-hidden">
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center p-4 text-center">
        ...
        {/* Contact Us Section */}
        <div className="mt-12 animate-fade-in-scale" style={{ animationDelay: '0.5s' }}>
          <h2 className="text-2xl sm:text-3xl text-white font-semibold mb-4" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.5)' }}>
            Contact Us
          </h2>
          <a 
          ...
          >
            <svg 
              ...
              className="h-12 w-12 sm:h-14 sm:w-14 text-green-500" 
              fill="currentColor"
              viewBox="0 0 24 24"
            >
