    ...
    <>
      ...
      <section id="services" className="relative h-screen w-full overflow-hidden flex flex-col">
        ...
        <div className="relative z-10 container mx-auto px-6 pt-32 h-full flex flex-col">
          <h2 className="font-heading text-5xl md:text-7xl mb-auto text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)]">Services</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-32">
            <div className="glass-card p-10 rounded-3xl border-l-4 border-l-[#b58916] bg-black/60 backdrop-blur-xl">
      ...
      <section className="relative min-h-screen w-full bg-[#0a0a0a] flex items-center py-20">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="h-[500px] w-full bg-cover bg-center rounded-2xl opacity-100 shadow-2xl" 
               style={{ backgroundImage: "url('https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=1000')" }}>
          </div>
          <div className="space-y-8">
            <div className="glass-card p-8 rounded-2xl hover:translate-x-4 transition-transform duration-500 bg-black/40">
              <h3 className="text-[#b58916] text-xl font-bold mb-2 uppercase">Trader Connect</h3>
              <p className="text-white font-normal">Meet fellow traders, investors, and financial enthusiasts. Network over cappuccinos, share insights, or form trading circles — your next big idea might start here.</p>
            </div>
            <div className="glass-card p-8 rounded-2xl hover:translate-x-4 transition-transform duration-500 delay-100 bg-black/40">
              <h3 className="text-[#b58916] text-xl font-bold mb-2 uppercase">Coffee & Charts</h3>
              <p className="text-white font-normal">Our signature event! A casual blend of market talk and mocha. Discuss global trends, price actions, and strategies — every sip fuels your next move.</p>
            </div>
            <div className="glass-card p-8 rounded-2xl hover:translate-x-4 transition-transform duration-500 delay-200 bg-black/40">
              <h3 className="text-[#b58916] text-xl font-bold mb-2 uppercase">Mentorship Zone</h3>
              <p className="text-white font-normal">Book 1-on-1 or group sessions with experienced traders. Learn smart strategies, risk management, and market psychology — practical wisdom brewed fresh daily.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative min-h-screen w-full bg-[#121212] flex items-center py-20 overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#b58916]/10 transform skew-x-12 translate-x-32"></div>
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 space-y-8">
            <div className="glass-card p-10 rounded-2xl hover:-translate-x-4 transition-transform duration-500 bg-black/60">
            ...
            <div className="glass-card p-10 rounded-2xl hover:-translate-x-4 transition-transform duration-500 delay-100 bg-black/60">
          ...
          <div className="order-1 lg:order-2 h-[500px] w-full bg-cover bg-center rounded-2xl shadow-2xl opacity-100" 
